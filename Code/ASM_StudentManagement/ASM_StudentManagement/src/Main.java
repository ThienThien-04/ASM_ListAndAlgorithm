...
public class Main {
    public static void main(String[] args) {
        ...
        st.addStudent(students, new Student("BH001","Do Viet Anh", 8.0));

        st.addStudent(students, new Student("BH002","Do Viet Em", 7.5));

        st.addStudent(students, new Student("BH003","Do Viet Trung", 6.0));
        ...
        edit.editStudent(students, 1, new Student("BH009", "Do Viet Teo", 4));
        System.out.println("********* List data of students after updated **********");
        for (Student s : students){
            System.out.println("ID = " + s.id +" , " + "fullName = " + s.fullName + " , " + "mark = " + s.mark + " , " + "rank = " + s.rank);
        }
        System.out.println("********* Edit Student By Id **********");
        edit.editStudentById(students, "BH009", new Student("BH009", "Do Viet Ty", 9.0));
